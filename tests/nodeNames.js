...
const { localName, namespaceUri, hasLocalName, isInNamespace, hasName, allChildNodes } = require('..');
...
describe('node name tests', () => {
    ...
    it('should test namespaces', () => {
        const inSeries = isInNamespace(NS_SERIES);
        const inPeople = isInNamespace(NS_PEOPLE);
