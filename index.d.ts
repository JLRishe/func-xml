...
export function hasName(localName: string, namespaceURI: string): (node: Node) => boolean;

export function allChildNodes(node: Node): Node[];
export function childNodes(localName: string, namespaceURI?: string): (node: Node) => Node[];

export function allChildEls(node: Node): Element[];
export function childEls(localName: string, namespaceURI?: string): (node: Node) => Element[]

export function allAttributes(element: Element): Attr[];
export function attributes(localName: string, namespaceURI?: string): (element: Element) => Attr[];
export function attribute(localName: string, namespaceURI?: string): (element: Element) => Attr;

export function attributeValue(localName: string, namespaceURI?: string): (element: Element) => string;
